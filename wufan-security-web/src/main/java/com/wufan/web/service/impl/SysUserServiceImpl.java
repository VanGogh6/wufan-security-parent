...
import com.wufan.web.mapper.SysRoleMapper;
import com.wufan.web.mapper.SysUserMapper;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    @Override
    public List<SysUser> getStudentList(String designId) {
        List<SysUser>  list=baseMapper.getStudentList(designId);
        return list;
    }

    @Override
    public SysUser getTeacherByDesignId(String designId) {
        SysUser teacher=baseMapper.getTeacherByDesignId(designId);
        return teacher;
    }

    @Override
    public List<SysUser> getStudentsByClazzId(String clazzId) {
        return baseMapper.getStudentsByClazzId(clazzId);
    }
}
